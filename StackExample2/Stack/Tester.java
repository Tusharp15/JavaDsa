...
class Tester {
    ...
    public static void reverseList(Node head, LinkedList reversedLinkedList) {
        ...
        if (head != null) {
            reverseListRecursive(head, null, reversedLinkedList);
        }
    }

    private static void reverseListRecursive(Node current, Node previous, LinkedList reversedLinkedList) {
        if (current.getNext() != null) {
            reverseListRecursive(current.getNext(), current, reversedLinkedList);
        }
        ...
        if (previous != null) {
            ...
            // If the original list has only one node, add it to the reversedLinkedList
            reversedLinkedList.addAtEnd(current.getData());
        }
    }
}
