    ...
    public static Queue[] splitQueue(Queue queue) {
        ...
        while (!queue.isEmpty()) {
            ...
            if (currentElement % 2 == 0) {
                // Enqueue to the even queue
                evenQueue.enqueue(currentElement);
            } else {
                // Enqueue to the odd queue
                oddQueue.enqueue(currentElement);
            }
        }

        // Return an array containing the two queues
